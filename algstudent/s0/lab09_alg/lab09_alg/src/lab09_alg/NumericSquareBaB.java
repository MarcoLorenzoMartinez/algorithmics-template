...
public class NumericSquareBaB {
	...
	public void computeBaB(String filename) { // Calling the branchAndBound method with the matrix of the provided file
	...
	public void branchAndBound(Node rootNode) {
	    ...
	    while (!heap.empty() && heap.estimateBest() < pruneLimit) { // While there are nodes to find solutions in the heap and the best heuristic of the heap is under the prune limit
